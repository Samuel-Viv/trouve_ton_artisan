    ...
    <div>
      <main>
          ...
          <div className="col-md-12">
            ...
            <div className="presentation">
              <div className="text-presentation">
                ...
                <p>
                  La région Auvergne-Rhône-Alpes, vous propose cette plateforme afin de trouver des
                  artisans qualifiés au sein de votre région. Nous facilitons la mise en relation
                  entre les particuliers et les artisans pour tous types de projets, que ce soit
                  pour des travaux de rénovation, de construction, de décoration ou autres.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="etape">
            <div className="text-etape col-md-6">
              ...
              <p>
                ...
                choisie. Consultez leurs compétences, leurs réalisations précédentes et les avis des
                clients pour trouver celui qui correspond le mieux à votre besoin.
              </p>
              ...
              <p>
                ...
                toutes vos questions, demandez des renseignements sur ses prestations ou demandez un
                devis personnalisé.
              </p>
        ...
        <ul>
          ...
          <li>
            Service client réactif et assistance personnalisée pour répondre à toutes vos questions.
          </li>
          <li>
            Garantie d'une réponse sous 48 heures pour toutes vos demandes de renseignements ou
            devis.
          </li>
        </ul>
        
        <p>
          Commencez dès maintenant à chercher l'artisan essentiel à votre projet en utilisant notre
          plateforme simple et efficace !
        </p>
        </div>
        </div>
